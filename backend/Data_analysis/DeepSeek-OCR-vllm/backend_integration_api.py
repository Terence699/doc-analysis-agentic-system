...
try:
    ...
    print("✅ 成功导入 Information_structuring, visualizer 和 pdf_exporter 模块")
...
# OCR服务配置 (根据你的test文件)
OCR_SERVICE_URL = "http://192.168.110.131:8707/ocr"  # 你的实际OCR服务地址
RESULTS_DIR = Path("/tmp/ocr_results")  # 临时存储结果
...
if __name__ == "__main__":
    print("🚀 启动智能数据分析API服务...")
    print("=" * 70)
    print(f"📖 API文档: http://0.0.0.0:8708/docs")
    print(f"🔍 根路径: http://0.0.0.0:8708/")
    print()
    print("📝 OCR处理流程:")
    print(f"  1️⃣  上传文档: POST /ocr")
    print(f"  2️⃣  查询状态: GET /status/{{task_id}}")
    print(f"  3️⃣  获取结果: GET /results/{{task_id}}")
    print(f"  4️⃣  查看报告: GET /report/{{task_id}}")
    print()
    print("💬 智能问答分析:")
